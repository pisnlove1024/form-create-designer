...
import chart from './rule/chart';
import codePreview from './rule/codePreview';
import yamlTreeEditor from './rule/yamlTreeEditor';
...
const ruleList = [
    ...
    alert, button, text, title, html, divider, tag, image, chart, codePreview, yamlTreeEditor, dataTable,
