const ZhCn = {
    ...
    dataTableActions: {
        ...
        hide: '隐藏',
        confirm: '二次确认',
        confirmMessage: '确认文案（可选）',
        confirmTitle: '确认标题（可选）',
        message: '结果提示',
        successMessage: '成功提示（可选）',
        errorMessage: '失败提示（可选）',
        requiredError: '操作 ID 和名称不能为空',
        duplicateError: '操作 ID 不能重复',
        callback: '回调',
        operation: '操作',
        add: '添加',
        placeholder: '请选择',
    ...
    globalData: {
        ...
        autoSync: '数据变更自动更新绑定组件',
        autoSyncInfo: '开启后，运行时修改该全局数据源会自动刷新引用它的组件内容',
    ...
    com: {
        ...
        fcYamlTreeEditor: {
            ...
            props: {
                dataSource: '数据来源',
                yaml: 'YAML 默认内容',
                yamlPlaceholder: '请输入 YAML 默认内容',
                schema: 'JSON Schema',
                schemaPlaceholder: '请输入 JSON Schema（可选）',
                height: '高度',
                indent: '缩进空格数',
                readonly: '只读',
                disabled: '禁用',
            ...
            runtime: {
                title: 'YAML 结构',
                formatHint: '树形编辑会自动生成规范 YAML',
                nodeCount: '{count} 个节点',
                sourceTitle: 'YAML 源码',
                unapplied: '未应用',
                sourcePlaceholder: '请输入单文档 YAML',
                applyToTree: '应用到树',
                sourceHelp: '应用后会校验 YAML，并按当前树编辑规则规范化输出。',
                inspectorTitle: '节点属性',
                keyLabel: 'Key',
                ...
                nullShort: 'Null',
                nullValue: 'null',
                unsupportedAlias: 'YAML 锚点和别名暂不支持树形编辑，请改为普通节点后再编辑。',
                unsupportedTag: '自定义 YAML tag 暂不支持树形编辑。',
                scalarKeyOnly: 'YAML 树编辑器仅支持标量类型的 Key。',
                schemaJsonParseError: 'Schema JSON 解析失败：{message}',
                invalidFormat: '格式无效',
                invalidSchema: 'Schema 必须是一个 JSON 对象。',
                singleDocumentOnly: '仅支持编辑单个 YAML 文档。',
                parseError: 'YAML 解析失败：{message}',
                unknownError: '未知错误',
                commentWarning: '当前 YAML 包含注释；修改后会按规范格式重新生成，注释和原始排版不会保留。',
                generateError: 'YAML 生成失败：{message}',
                schemaTypeMismatch: '{path} 类型不符合 Schema，期望 {types}。',
                enum: '{path} 的值不在允许范围内。',
                const: '{path} 必须是固定值 {value}。',
                required: '{path} 缺少必填 Key：{key}。',
                minProperties: '{path} 至少需要 {count} 个 Key。',
                maxProperties: '{path} 最多允许 {count} 个 Key。',
                additionalProperties: '{path} 不允许 Key：{key}。',
                minItems: '{path} 至少需要 {count} 项。',
                maxItems: '{path} 最多允许 {count} 项。',
                minLength: '{path} 的文本长度不能少于 {count}。',
                maxLength: '{path} 的文本长度不能超过 {count}。',
                pattern: '{path} 的文本格式不符合要求。',
                minimum: '{path} 不能小于 {value}。',
                maximum: '{path} 不能大于 {value}。',
                emptyKey: '{path} 中存在空 Key。',
                duplicateKey: '{path} 中存在重复 Key：{key}。',
                invalidNumber: '{path} 的数字值无效。',
            },
        },
        fcChart: {
            name: '图表',
            props: {
                ...
                averageLineName: '平均线名称',
                emptyText: '空数据提示文字',
            },
            averageLineDefault: '平均值',
            emptyDataText: '暂无数据',
            chartTypes: {
                line: '折线图',
                area: '面积图',
        ...
        fcDataTable: {
            ...
            props: {
                ...
                pageSize: '每页条数',
                total: '总条数',
                cursorPagination: '远程游标分页',
                cursorPreset: '分页预设',
                cursorFetch: '游标请求配置',
                cursorAutoLoad: '打开时自动请求',
                cursorRequestPath: '请求 cursor 路径',
                cursorPageSize: '每页条数',
                cursorPageSizePath: '请求 pageSize 路径',
                cursorEmptyCursorBehavior: '空 cursor 处理',
                cursorDataPath: '响应数据路径',
                cursorNextPath: '下一页 cursor 路径',
                cursorHasMorePath: '是否还有下一页路径',
                cursorPrevPath: '上一页 cursor 路径',
                cursorTotalPath: '总条数路径',
                cursorInitialCursor: '初始 cursor',
                cursorPrevLabel: '上一页按钮文案',
                cursorNextLabel: '下一页按钮文案',
                height: '表格高度',
                maxHeight: '表格最大高度',
            ...
            actionDefault: '操作',
            actionConfirm: '确认执行该操作吗？',
            actionConfirmTitle: '提示',
            cursorPrev: '上一页',
            cursorNext: '下一页',
            cursorPaginationInfo: '开启后，表格不再一次性拉取全部数据，而是通过游标请求当前页，并在表格下方显示上一页/下一页按钮。',
            cursorPresetInfo: '选择一种常见分页接口形态。下面的路径字段留空时使用预设默认值；填写后覆盖预设。',
            cursorFetchInfo: '用于请求单页数据的 Fetch 配置。点击上一页/下一页时，组件会复制这份配置并写入当前 cursor 后重新请求。',
            cursorRequestPathInfo: '当前 cursor 写入请求配置的位置，例如 query.cursor、query._start 或 data.cursor。留空使用预设默认。第一页 cursor 为空时按“空 cursor 处理”执行。',
            cursorPageSizeInfo: '固定每页条数。为 0 时不主动写入 pageSize，仅使用请求配置中的原始值。',
            cursorPageSizePathInfo: '每页条数写入请求配置的位置，例如 query.limit、query.page_size 或 data.pageSize。留空使用预设默认；预设也为空时不写入。',
            cursorEmptyCursorBehaviorInfo: '第一页 cursor 为空时的处理：omit 删除字段，keep 写入空字符串，null 写入 null。',
            cursorDataPathInfo: '从接口响应中取表格行数组的路径，例如 rows、data.list 或 Data.messages。留空使用预设默认。',
            cursorNextPathInfo: '从接口响应中取下一页 cursor 的路径，例如 next_cursor 或 data.nextCursor。留空使用预设默认。',
            cursorHasMorePathInfo: '从接口响应中判断是否还有下一页的路径。支持 true/false、1/0、"true" 等值。留空使用预设默认；若最终为空，则用 next cursor 是否存在来判断。',
            cursorPrevPathInfo: '可选。后端返回上一页 cursor 时填写；不填时组件使用本地 cursor 栈支持上一页。',
            cursorTotalPathInfo: '可选。响应里总条数所在路径，仅通过 cursorPageChange 事件抛出，不影响下一页按钮。',
            cursorInitialCursorInfo: '第一页请求使用的初始 cursor，通常留空。',
            cursorPrevLabelInfo: '可选。留空时使用内置文案“上一页”。',
            cursorNextLabelInfo: '可选。留空时使用内置文案“下一页”。',
            emptyCursorBehavior: {
                omit: '删除字段',
                keep: '写入空字符串',
                'null': '写入 null',
        ...
        html: {
            ...
            props: {
                formCreateNative: '是否显示标题',
                formCreateTitle: '标题',
                formCreateHtmlPreview: '在设计器中渲染 HTML',
                formCreateChild: '内容',
            }
        },
        input: {
