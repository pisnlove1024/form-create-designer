const En = {
    ...
    dataTableColumns: {
        ...
        requiredError: 'Column label is required',
        sortType: {
            none: 'No sort',
            normal: 'Normal sort',
            remote: 'Remote sort',
    ...
    dataTableActions: {
        ...
        hide: 'Hide',
        confirm: 'Confirm',
        confirmMessage: 'Confirm message (optional)',
        confirmTitle: 'Confirm title (optional)',
        message: 'Messages',
        successMessage: 'Success message (optional)',
        errorMessage: 'Error message (optional)',
        requiredError: 'Action ID and label are required',
        duplicateError: 'Action IDs must be unique',
        callback: 'Callback',
        operation: 'Operation',
        add: 'Add',
        placeholder: 'Please select',
    ...
    globalData: {
        ...
        autoSync: 'Auto-update bound components',
        autoSyncInfo: 'When enabled, runtime changes to this global data source refresh components that reference it',
    ...
    com: {
        ...
        fcYamlTreeEditor: {
            name: 'YAML Tree Editor',
            props: {
                dataSource: 'Data source',
                yaml: 'Default YAML',
                yamlPlaceholder: 'Enter default YAML',
                schema: 'JSON Schema',
                schemaPlaceholder: 'Enter JSON Schema (optional)',
                height: 'Height',
                ...
                showFormatHint: 'Show formatting hint',
            },
            viewModes: {
                tree: 'Tree editor',
                source: 'YAML source',
            ...
            runtime: {
                ...
                formatHint: 'Tree edits generate normalized YAML',
                nodeCount: '{count} nodes',
                sourceTitle: 'YAML source',
                unapplied: 'Not applied',
                sourcePlaceholder: 'Enter a single YAML document',
                applyToTree: 'Apply to tree',
                sourceHelp: 'Applying validates YAML and normalizes it using the current tree editing rules.',
                ...
                rootNode: 'Root node',
                listItem: 'List item',
                listItemWithIndex: 'List item {index}',
                mapPreview: '{count} items',
                listPreview: '{count} items',
                mapShort: 'Map',
                listShort: 'List',
                textShort: 'Text',
                numberShort: 'Number',
                ...
                nullShort: 'Null',
                nullValue: 'null',
                unsupportedAlias: 'YAML anchors and aliases are not supported in tree editing. Convert them to regular nodes first.',
                unsupportedTag: 'Custom YAML tags are not supported in tree editing.',
                scalarKeyOnly: 'The YAML tree editor only supports scalar keys.',
                schemaJsonParseError: 'Schema JSON parsing failed: {message}',
                invalidFormat: 'Invalid format',
                invalidSchema: 'Schema must be a JSON object.',
                singleDocumentOnly: 'Only a single YAML document can be edited.',
                parseError: 'YAML parsing failed: {message}',
                unknownError: 'Unknown error',
                commentWarning: 'This YAML contains comments. Editing regenerates normalized YAML, so comments and original formatting will not be preserved.',
                generateError: 'YAML generation failed: {message}',
                schemaTypeMismatch: '{path} does not match the schema type; expected {types}.',
                enum: '{path} must be one of the allowed values.',
                const: '{path} must equal the fixed value {value}.',
                required: '{path} is missing the required key: {key}.',
                minProperties: '{path} requires at least {count} keys.',
                maxProperties: '{path} allows at most {count} keys.',
                additionalProperties: '{path} does not allow key: {key}.',
                minItems: '{path} requires at least {count} items.',
                maxItems: '{path} allows at most {count} items.',
                minLength: '{path} must contain at least {count} characters.',
                maxLength: '{path} must contain at most {count} characters.',
                pattern: '{path} does not match the required text format.',
                minimum: '{path} must be greater than or equal to {value}.',
                maximum: '{path} must be less than or equal to {value}.',
                emptyKey: '{path} contains an empty key.',
                duplicateKey: '{path} contains a duplicate key: {key}.',
                invalidNumber: '{path} contains an invalid number.',
            },
        },
        fcChart: {
            name: 'Chart',
            props: {
                ...
                averageLineName: 'Average line name',
                emptyText: 'Empty data text',
            },
            averageLineDefault: 'Average',
        ...
        fcDataTable: {
            ...
            props: {
                ...
                pageSize: 'Page size',
                total: 'Total',
                cursorPagination: 'Remote cursor pagination',
                cursorPreset: 'Pagination preset',
                cursorFetch: 'Cursor request config',
                cursorAutoLoad: 'Auto request on mount',
                cursorRequestPath: 'Request cursor path',
                cursorPageSize: 'Page size',
                cursorPageSizePath: 'Request pageSize path',
                cursorEmptyCursorBehavior: 'Empty cursor behavior',
                cursorDataPath: 'Response data path',
                cursorNextPath: 'Next cursor path',
                cursorHasMorePath: 'Has more path',
                cursorPrevPath: 'Previous cursor path',
                cursorTotalPath: 'Total path',
                cursorInitialCursor: 'Initial cursor',
                cursorPrevLabel: 'Previous button label',
                cursorNextLabel: 'Next button label',
                height: 'Height',
                maxHeight: 'Max height',
            ...
            actionConfirm: 'Are you sure you want to run this action?',
            actionConfirmTitle: 'Confirm',
            cursorPrev: 'Previous',
            cursorNext: 'Next',
            cursorPaginationInfo: 'When enabled, the table requests only the current cursor page and renders Previous/Next buttons below the table.',
            cursorPresetInfo: 'Choose a common pagination shape. Empty path fields use preset defaults; filled fields override the preset.',
            cursorFetchInfo: 'Fetch config for one page. The component clones this config, writes the current cursor, and requests again when Previous/Next is clicked.',
            cursorRequestPathInfo: 'Where to write the current cursor in the request config, for example query.cursor, query._start, or data.cursor. Empty uses the preset default. Empty first-page cursor follows the empty cursor behavior.',
            cursorPageSizeInfo: 'Fixed page size. When 0, the component does not write pageSize and keeps the original fetch config.',
            cursorPageSizePathInfo: 'Where to write page size in the request config, for example query.limit, query.page_size, or data.pageSize. Empty uses the preset default; if the preset is also empty, it is not written.',
            cursorEmptyCursorBehaviorInfo: 'How to handle an empty first-page cursor: omit removes the field, keep writes an empty string, null writes null.',
            cursorDataPathInfo: 'Path to the row array in the response, for example rows, data.list, or Data.messages. Empty uses the preset default.',
            cursorNextPathInfo: 'Path to the next cursor in the response, for example next_cursor or data.nextCursor. Empty uses the preset default.',
            cursorHasMorePathInfo: 'Path that indicates whether the next page exists. Supports true/false, 1/0, and "true". Empty uses the preset default; if finally empty, next cursor presence is used.',
            cursorPrevPathInfo: 'Optional. Fill this when the backend returns a previous cursor; otherwise the component uses a local cursor stack.',
            cursorTotalPathInfo: 'Optional. Path to total count in the response. It is emitted by cursorPageChange only and does not affect the Next button.',
            cursorInitialCursorInfo: 'Initial cursor used for the first page request. Usually empty.',
            cursorPrevLabelInfo: 'Optional. Empty uses the built-in Previous label.',
            cursorNextLabelInfo: 'Optional. Empty uses the built-in Next label.',
            emptyCursorBehavior: {
                omit: 'Remove field',
                keep: 'Write empty string',
                'null': 'Write null',
            },
            cursorPresets: {
                nextCursorHasMore: 'next_cursor + has_more',
                nextCursorOnly: 'Next cursor only',
        ...
        html: {
            ...
            props: {
                formCreateNative: 'Whether to display title',
                formCreateTitle: 'Title',
                formCreateHtmlPreview: 'Render HTML in Designer',
                formCreateChild: 'Content',
            }
        },
        input: {
