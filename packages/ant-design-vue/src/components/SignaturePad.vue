<template>
    <div class="_fc-signature" :class="{disabled: disabled}">
        ...
        <a-modal class="_fc-signature-dialog" :title="padTitleText"
            ...
            <template #footer>
                <div>
                    <a-button @click="clear()">{{ formCreateInject.t('reset') || '重置' }}</a-button>
                    <a-button type="primary" :disabled="isEmpty" @click="submit">{{
